    ...
    return (
        ...
        <div className='section-container wider-container'>
          ...
          <ul>
            ...
            <li className='how-step narrow-img'><img src={recyclingBin} alt='four animated bottles'/><p>Consumers can drop off their refillable bottles.</p></li>
            <li className='how-arrow' alt='arrow'><img src={arrow} alt="arrow"/></li>
            <li className='how-step'><img src={bottlesInCar} alt='four animated bottles'/><p>We collect the refillable bottles from participating locations.</p></li>
            <li className='how-arrow' alt='arrow'><img src={arrow} alt="arrow"/></li>
